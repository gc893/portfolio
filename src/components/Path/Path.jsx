    ...
    return (
        <div className='page-section' style={{textAlign: 'center'}}>
            ...
            <div className='path-section'>
                <div>
                    <p style={{fontSize: '8rem', color: '#D4916C'}}><i class="fas fa-chart-pie"></i></p>
                ...
                <div>
                    <p style={{fontSize: '8rem', padding: '0', margin: '0', color: '#D4916C'}}><i class="fas fa-project-diagram"></i></p>
                ...
                <div>
                    <p style={{fontSize: '8rem', padding: '0', margin: '0', color: '#D4916C'}}><i class="fab fa-font-awesome-flag"></i></p>
                    <h5>Founder</h5>
                ...
                <div>
                    <p style={{fontSize: '8rem', padding: '0', margin: '0', color: '#D4916C'}}><i class="fas fa-file-code"></i></p>
